/**
 * indexer-app.module.ts의 19번 라인을 직접 실행
 */

import * as fs from 'fs';
import * as path from 'path';

describe('IndexerAppModule Line 19 Coverage', () => {
  it('should execute line 19: inject array', () => {
    const modulePath = path.join(__dirname, '../../../apps/indexer/src/indexer-app.module.ts');
